const http = require('http') //<co id="http_redirects_1" />
const https = require('https')
const url = require('url')
let request

function Request() {
  //<co id="http_redirects_2" />
  this.maxRedirects = 10
  this.redirects = 0
}

Request.prototype.get = function(href, callback) {
  const uri = url.parse(href) //<co id="http_redirects_3" />
...
const request = new Request() //<co id="http_redirects_7" />
